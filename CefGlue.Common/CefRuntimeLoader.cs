...
namespace Xilium.CefGlue.Common
{
    public static class CefRuntimeLoader
    {
        ...
        public static void Initialize(CefSettings settings = null, List<string> args = null, KeyValuePair<string, string>[] flags = null, CustomScheme[] customSchemes = null)
        {
            _delayedInitialization = (browserProcessHandler) => InternalInitialize(settings, args, flags, customSchemes, browserProcessHandler);
        }

        private static void InternalInitialize(CefSettings settings = null, List<string> args = null, KeyValuePair<string, string>[] flags = null, CustomScheme[] customSchemes = null, BrowserProcessHandler browserProcessHandler = null)
        {
            CefRuntime.Load();
            ...
            CefRuntime.Initialize(new CefMainArgs(new string[0]), settings, new BrowserCefApp(customSchemes, args, flags, browserProcessHandler), IntPtr.Zero);
